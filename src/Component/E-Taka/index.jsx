      ...
      <div>
        <div className="nav-bar-container">
          ...
          <div className={`nav ${selectedNav === null ? 'selected' : ''}`}
            ...
            <a href="/home" className={`nav-link ${selectedNav === null ? 'active' : ''}`}
              onClick={() => handleNavClick(null)}>
              Home
            </a>
            <a href="/services" className={`nav-link ${selectedNav === 'offer' ? 'active' : ''}`}
              onClick={() => handleNavClick('offer')}>
              Services
            </a>
            <a href="/about" className={`nav-link ${selectedNav === 'service' ? 'active' : ''}`}
              onClick={() => handleNavClick('service')}>
              About
            </a>
            <a href="/reviews" className={`nav-link ${selectedNav === 'menu' ? 'active' : ''}`}
              onClick={() => handleNavClick('menu')}>
              Reviews
            </a>
            <a href="/contact" className={`nav-link ${selectedNav === 'about' ? 'active' : ''}`}
...
export const Home =()=>{
    return(
        ...
        <div className="section-container">
            ...
            <img className="arrow" src="media/home.png"/>
            </div>
        </div> 
        </div>
    )
